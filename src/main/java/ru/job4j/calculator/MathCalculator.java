...
public class MathCalculator {
    ...
    public static double sumOpsResults(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат subtractAndDivide равен: " + subtractAndDivide(10, 20));
        System.out.println("Результат sumOpsResults равен: " + sumOpsResults(10, 20));
    }
}
